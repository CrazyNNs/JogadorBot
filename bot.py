...
class ViewConquistas(discord.ui.View):
    ...
    async def voltar(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        embed2.add_field(name="<:SacoJoyensIcon:1525722643062591599> Economia", value=f"> **Joyens:** ``{joyens}``", inline=False)
        embed2.add_field(
            name="📊 Outros",
    ...
    async def gerar_embed_e_imagem(self):
        ...
        for i, (banner_id, nome, descricao, preco, arquivo, raridade) in enumerate(pagina_banners):
            ...
            embed.add_field(
                ...
                value=f"{descricao}\n<:SacoJoyensIcon:1525722643062591599> **{preco} Joyens** | {status}",
                inline=False
            )
...
class ViewAjuda(discord.ui.View):
    ...
    def embed_inicial(self):
        ...
        embed.add_field(
            name="<:SacoJoyensIcon:1525722643062591599> Economia",
    ...
    def embed_economia(self):
        embed = discord.Embed(
            title="<:SacoJoyensIcon:1525722643062591599> Economia",
        ...
        embed.set_footer(text="<:SacoJoyensIcon:1525722643062591599> Economia • JogadorBot")
        return embed
    ...
    @discord.ui.button(emoji="<:SacoJoyensIcon:1525722643062591599>", style=discord.ButtonStyle.primary, row=0)
...
class ViewAjudaCategoria(discord.ui.View):
    ...
    @discord.ui.button(emoji="<:SacoJoyensIcon:1525722643062591599>", style=discord.ButtonStyle.secondary, row=0)
    async def btn_economia(self, interaction: discord.Interaction, button: discord.ui.Button):
...
async def diario(ctx):
    ...
    embed = discord.Embed(title="<:SacoJoyensIcon:1525722643062591599> Recompensa Diária!", color=discord.Color.gold())
...
async def saldo(ctx, membro: discord.Member = None):
    if membro is None:
        membro = ctx.author
    joyens = buscar_joyens(membro.id)
    embed = discord.Embed(title=f"<:SacoJoyensIcon:1525722643062591599> Saldo de {membro.display_name}", color=discord.Color.gold())
...
async def adminbot_dar(
    ...
    if cat == "xp":
        ...
        embed = discord.Embed(
            title="<:SacoJoyensIcon:1525722643062591599> Joyens Concedidos!",
